...
<template>
  <div class="container py-5">
    <div class="text-center mb-6">
      ...
      <p class="text-muted">
        Participate in beneficial health activities and contribute to the community
      </p>
    </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-6 col-lg-4" v-for="event in filteredEvents" :key="event.id">
        <div class="card h-100 shadow-sm hover-shadow">
          ...
          <div class="card-body">
            ...
            <div class="d-flex align-items-center mb-3">
              ...
              <span class="ms-3 text-muted small"
                >Avg: {{ eventRating(event.id).average.toFixed(2) }} Stars</span
              >
            </div>
          ...
          <div class="card-footer bg-transparent">
            <router-link :to="`/event/${event.id}`" class="btn btn-outline-primary w-100">
              View Details
            </router-link>
          </div>
        </div>
